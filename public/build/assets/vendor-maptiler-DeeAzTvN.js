...
import { Q as QuickLRU, v as v4, L, a as gBase64, c as ci } from "./vendor-common-VklLotv9.js";
...
const Language = __spreadValues(__spreadValues({}, NonISOLanguage), ISOLanguage);
...
function getAutoLanguage() {
  ...
  if (typeof navigator === "undefined") {
    ...
    return langInfo != null ? langInfo : Language.ENGLISH;
  }
  const canditatelangs = Array.from(
    new Set(navigator.languages.map((l) => l.split("-")[0]))
  ).map((code) => getLanguageInfoFromCode(code)).filter((li) => li);
  return (_a2 = canditatelangs[0]) != null ? _a2 : Language.ENGLISH;
}
...
function toValidGeocodingLanguageCode(lang) {
  ...
  return (langInfo == null ? void 0 : langInfo.geocoding) ? langInfo.code : null;
}
function addCommonForwardAndReverseGeocodingOptions(searchParams, options) {
  const { apiKey, limit, types, excludeTypes } = options;
  searchParams.set("key", apiKey != null ? apiKey : config.apiKey);
  if (limit !== void 0) {
...
async function forward(query, options = {}) {
  ...
  if (!res.ok) {
    throw new ServiceError(res, (_a2 = customMessages$4[res.status]) != null ? _a2 : "");
  }
...
async function byId(id, options = {}) {
  ...
  endpoint.searchParams.set("key", (_a2 = options.apiKey) != null ? _a2 : config.apiKey);
  addLanguageGeocodingOptions(endpoint.searchParams, options);
  const res = await callFetch(endpoint.toString());
  if (!res.ok) {
    throw new ServiceError(res, (_b = customMessages$4[res.status]) != null ? _b : "");
  }
  return await res.json();
}
...
class MapStyleVariant {
   ...
   */
  getVariants() {
    return this.referenceStyle.getVariants().filter((v2) => v2 !== this).map((v2) => {
      this.warnIfDeprecated(v2);
      return v2;
    });
  }
  /**
...
class ReferenceMapStyle {
   ...
   */
  addVariant(v2) {
    this.variants[v2.getType()] = v2;
    this.orderedVariants.push(v2);
  }
  /**
...
function centered(center, zoom, options = {}) {
  ...
  const format = (_a2 = options.format) != null ? _a2 : "png";
  ...
  endpoint.searchParams.set("key", (_e2 = options.apiKey) != null ? _e2 : config.apiKey);
...
function haversineIntermediateWgs84(pos1, pos2, ratio) {
  ...
  const b2 = Math.sin(ratio * δ) / Math.sin(δ);
  const x = a * Math.cos(φ1) * Math.cos(λ1) + b2 * Math.cos(φ2) * Math.cos(λ2);
  const y = a * Math.cos(φ1) * Math.sin(λ1) + b2 * Math.cos(φ2) * Math.sin(λ2);
  const z2 = a * Math.sin(φ1) + b2 * Math.sin(φ2);
  const φ3 = Math.atan2(z2, Math.sqrt(x * x + y * y));
...
async function computeOnClient(positions, apiKey, zoom) {
  ...
  if (!terrainTileJson) {
    ...
    if (res.ok) {
      ...
      throw new ServiceError(res, (_a2 = customMessages[res.status]) != null ? _a2 : "");
    }
  }
  ...
  let usedZoom = ~~(zoom != null ? zoom : maxZoom);
  ...
  if (fulfilledRButNotOkRes.length) {
    throw new ServiceError(
      ...
      (_b = customMessages[fulfilledRButNotOkRes[0].status]) != null ? _b : ""
    );
  }
...
async function batch(positions, options = {}) {
  ...
  if (positions.length === 0)
    return [];
  const apiKey = (_a2 = options.apiKey) != null ? _a2 : config.apiKey;
...
async function fromLineString(ls2, options = {}) {
  ...
  (_a2 = options.computeOn) != null ? _a2 : options.computeOn = canParsePixelData() ? "client" : "server";
...
var ai = (r, e, t) => e in r ? ni(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var v = (r, e, t) => ai(r, typeof e != "symbol" ? e + "" : e, t), hr = (r, e, t) => e.has(r) || Tn("Cannot " + t);
var k = (r, e, t) => (hr(r, e, "read from private field"), t ? t.call(r) : e.get(r)), Z = (r, e, t) => e.has(r) ? Tn("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(r) : e.set(r, t), K = (r, e, t, n) => (hr(r, e, "write to private field"), e.set(r, t), t), Y = (r, e, t) => (hr(r, e, "access private method"), t);
const z = __spreadValues({
  /**
...
function Pn() {
  ...
  return (_a2 = Array.from(new Set(navigator.languages.map((e) => e.split("-")[0]))).map((e) => getLanguageInfoFromCode(e)).filter((e) => e)[0]) != null ? _a2 : z.LOCAL;
}
const X = {
...
function wi() {
  ...
  if (r === "unavailable" || r === "requested")
    try {
      L.setRTLTextPlugin(X.rtlPluginURL, true);
    } catch (e) {
    }
}
function Si(r, e) {
...
function $n(r) {
  return (e, t) => {
    var _a2;
    if (r != null) {
      const n = r(e, t), a = Fn((_a2 = n == null ? void 0 : n.url) != null ? _a2 : "", t);
...
function Ti(r) {
  var _a2;
  var n;
  const e = new RegExp("\\{name(?::(?<language>\\S+))?\\}", "g"), t = [];
  for (; ; ) {
    const a = e.exec(r);
    if (!a) break;
    const o = (_a2 = (n = a.groups) == null ? void 0 : n.language) != null ? _a2 : null;
    t.push(o);
  }
  return t;
}
...
class Nn extends Ri {
  constructor(t = {}) {
    ...
    v(this, "logoURL", "");
    v(this, "linkURL", "");
    this.logoURL = (_a2 = t.logoURL) != null ? _a2 : X.maptilerLogoURL, this.linkURL = (_b = t.linkURL) != null ? _b : X.maptilerURL;
  }
  onAdd(t) {
    var _a2;
    this._map = t, this._compact = (_a2 = this.options.compact) != null ? _a2 : false, this._container = window.document.createElement("div"), this._container.className = "maplibregl-ctrl";
...
class $e {
  ...
  static fromString(e) {
    return e ? new $e({ name: e, available: false }) : null;
  }
}
class fe {
  constructor(e, t, n) {
...
function ur(r, e, t, n) {
  ...
  return hl(o, a) === 0 ? false : !!(Vn(r, e, t, n) && Vn(t, n, r, e));
}
function pl(r, e, t) {
  for (const n of t)
...
function El(r, e) {
  ...
  for (const i of e) {
    switch (i.type) {
      case "Point":
        o = Math.min(o, Ht(n, false, [i.coordinates], false, a, o));
        break;
      case "LineString":
        o = Math.min(o, Ht(n, false, i.coordinates, true, a, o));
        break;
      case "Polygon":
        o = Math.min(o, Gt(n, false, i.coordinates, a, o));
        break;
    }
    if (o === 0)
      return o;
...
function Al(r, e) {
  ...
  for (const i of e) {
    switch (i.type) {
      case "Point":
        o = Math.min(o, Ht(n, true, [i.coordinates], false, a, o));
        break;
      case "LineString":
        o = Math.min(o, Ht(n, true, i.coordinates, true, a, o));
        break;
      case "Polygon":
        o = Math.min(o, Gt(n, true, i.coordinates, a, o));
        break;
    }
    if (o === 0)
      return o;
...
function Tl(r, e) {
  ...
  for (const i of e)
    for (const s of n) {
      switch (i.type) {
        case "Point":
          o = Math.min(o, Gt([i.coordinates], false, s, a, o));
          break;
        case "LineString":
          o = Math.min(o, Gt(i.coordinates, true, s, a, o));
          break;
        case "Polygon":
...
function Zt(r) {
  ...
  }), t ? cr(r) && pr(r, ["zoom", "heatmap-density", "elevation", "line-progress", "accumulated", "is-supported-script"]) : false;
}
function cr(r) {
  if (r instanceof he) {
...
function ro(r) {
  ...
  function f(m, y) {
    ...
    return t === "categorical" && w === "number" && (!isFinite(g) || Math.floor(g) !== g) ? [new b(m.key, x, `integer expected, found ${g}`)] : t !== "categorical" && w === "number" && o !== void 0 && g < o ? [new b(m.key, x, "stop domain values must appear in ascending order")] : (o = g, t === "categorical" && g in a ? [new b(m.key, x, "stop domain values must be unique")] : (a[g] = true, []));
  }
  function h(m) {
...
class Jl extends Ma {
  constructor(t = {}) {
    var _a2, _b, _c;
    super({
      showCompass: (_a2 = t.showCompass) != null ? _a2 : true,
      showZoom: (_b = t.showZoom) != null ? _b : true,
      visualizePitch: (_c = t.visualizePitch) != null ? _c : true
    });
...
class eu extends Pi {
  constructor() {
    ...
    v(this, "_updateCamera", (t) => {
      var _a2;
      var c;
      const n = new sa(t.coords.longitude, t.coords.latitude), a = t.coords.accuracy, i = __spreadProps(__spreadValues({
        bearing: this._map.getBearing()
      }, this.options.fitBoundsOptions), {
        linear: true
      }), s = this._map.getZoom();
      s > ((_a2 = (c = this.options.fitBoundsOptions) == null ? void 0 : c.maxZoom) != null ? _a2 : 30) && (i.zoom = s), this._map.fitBounds(Ql.fromLngLat(n, a), i, {
...
Ae = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ new WeakMap();
class ru {
  constructor() {
    v(this, "map");
    v(this, "container");
...
Ct = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new WeakMap(), v(Gr, "controlCallbacks", ut);
...
class Er {
  constructor(e, t) {
    ...
    Z(this, ee, false);
    Z(this, Et);
    e.style !== void 0 && K(this, ee, true), K(this, J, __spreadProps(__spreadValues(__spreadProps(__spreadValues({
      // set defaults
      zoomAdjust: -4,
      position: "top-right"
    }, t), {
...
J = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), Et = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakSet(), bo = function(e) {
...
function jt(r) {
  ...
  try {
    ...
    const n = (_a2 = e.match(/(\d\.\d(\d+)?|\d{3}|\d{2}|\d{1})/gi)) != null ? _a2 : ["0", "0", "0"];
    if (e.includes("rgb")) {
...
let ct;
function bu(r) {
  return ct = ct != null ? ct : document.createElement("canvas").getContext("2d"), ct ? (ct.fillStyle = r, ct.fillStyle) : "#000000";
}
...
function Iu({ gl: r, faces: e, onReady: t, forceRefresh: n }) {
  ...
  const a = Ft != null ? Ft : r.createTexture();
  ...
  Promise.all(i).then((s) => {
    ...
    for (let u = 0; u < s.length; u++) {
      const p = r.RGBA, d = r.RGBA, f = r.UNSIGNED_BYTE, { image: h, key: m } = (_a2 = s[u]) != null ? _a2 : {};
      if (!h || !m) {
...
function $u(r, e) {
  ...
  return __spreadProps(__spreadValues({}, t), {
    ...
    color: (_b = (_a2 = t.color) != null ? _a2 : He[n].color) != null ? _b : "hsl(233,100%,92%)"
  });
}
class Pr {
  /**
  ...
  constructor(e) {
    ...
    v(this, "map");
    v(this, "faces");
    v(this, "useCubemapTexture", true);
    v(this, "currentFadeOpacity", 0);
    v(this, "cubeMapNeedsUpdate", false);
    v(this, "bgColor");
    ...
    v(this, "options");
    v(this, "animationActive", true);
    v(this, "imageIsAnimating", false);
    v(this, "imageFadeInDelta", 0);
    const t = $u(e, wa);
    this.options = t, this.currentFacesDefinitionKey = JSON.stringify((_b = (_a2 = t.faces) != null ? _a2 : t.preset) != null ? _b : t.path), this.bgColor = [0, 0, 0, 0], this.targetBgColor = jt(t.color), this.faces = Sa(t), this.useCubemapTexture = this.faces !== null;
  }
  /**
  ...
  updateCubemap({ facesNeedUpdate: e } = { facesNeedUpdate: true }) {
    ...
    const t = zu.filter((n) => n === "cubeSampler" || n === "fadeOpacity" ? this.useCubemapTexture : true);
    this.cubemap = xo({
      gl: this.gl,
  ...
  async setCubemapFaces(e) {
    ...
    this.faces = Sa(e), this.currentFacesDefinitionKey = JSON.stringify((_b = (_a2 = e.faces) != null ? _a2 : e.preset) != null ? _b : e.path);
  }
  /**
  ...
  async setCubemap(e) {
    ...
    this.options = t;
    const n = JSON.stringify((_b = (_a2 = t.faces) != null ? _a2 : t.preset) != null ? _b : t.path), a = this.currentFacesDefinitionKey !== n;
    a && (await this.setCubemapFaces(t), this.cubeMapNeedsUpdate = true);
    const o = jt(t.color);
...
function ko(r) {
  return r ? typeof r == "boolean" ? true : !(!r.path && !r.preset && !r.faces && !r.color || r.preset && !(r.preset in He) || r.faces && (!r.faces.pX || !r.faces.nX || !r.faces.pY || !r.faces.nY || !r.faces.pZ || !r.faces.nZ)) : false;
}
function Sa(r) {
  var _a2;
  if (r.faces)
  ...
  if (r.path) {
    const e = r.path.baseUrl, t = (_a2 = r.path.format) != null ? _a2 : "png";
    return {
      pX: `${e}/px.${t}`,
      nX: `${e}/nx.${t}`,
      pY: `${e}/py.${t}`,
...
class Rr {
  ...
  constructor(e) {
    ...
    this.gradient = __spreadValues(__spreadValues({}, je), e);
  }
  /**
  ...
  async setGradient(e) {
    ...
    e === true ? (this.gradient.scale = je.scale, this.gradient.stops = je.stops) : (this.gradient.scale = (_a2 = e.scale) != null ? _a2 : je.scale, this.gradient.stops = (_b = e.stops) != null ? _b : je.stops), await this.animateIn();
  }
  setAnimationActive(e) {
    this.animationActive = e;
  }
...
function Bu(r) {
  return typeof r == "boolean" ? true : !(typeof r.scale != "number" || !r.stops || r.stops.length === 0 || r.stops.some((e) => typeof e[0] != "number" || typeof e[1] != "string"));
}
const qu = {
  POINT: "POINT",
  COUNTRY: "COUNTRY"
...
let Lo = class Co extends L.Map {
  constructor(t) {
    ...
    if (this.on("style.load", () => {
      ...
      const h = toLanguageInfo(t.language, z);
      this.primaryLanguage = h != null ? h : j.primaryLanguage;
    }
    this.forceLanguageUpdate = !(this.primaryLanguage === z.STYLE || this.primaryLanguage === z.STYLE_LOCK), this.languageAlwaysBeenStyle = this.primaryLanguage === z.STYLE, this.terrainExaggeration = (_a2 = t.terrainExaggeration) != null ? _a2 : this.terrainExaggeration, this.curentProjection = t.projection, this.on("styledata", () => {
      ...
      if (t.scaleControl) {
        const m = t.scaleControl === true || t.scaleControl === void 0 ? "bottom-right" : t.scaleControl, y = new zi({ unit: j.unit });
    ...
    let c = false, p = false, d;
    this.once("ready", () => {
      c = true, p && this.fire("loadWithTerrain", d);
      ...
      if (typeof h == "object") {
        ...
        this.minimap = new Er(h, {
          ...
          pixelRatio: ti,
          validateStyle: ri
        }), this.addControl(this.minimap, (_a3 = h.position) != null ? _a3 : "bottom-left");
      } else h === true ? (this.minimap = new Er({}, t), this.addControl(this.minimap, "bottom-left")) : h !== void 0 && h !== false && (this.minimap = new Er({}, t), this.addControl(this.minimap, h));
    });
    const f = (h) => {
      h.terrain && (p = true, d = {
    ...
    this.on("terrain", f), t.terrain && this.enableTerrain((_b = t.terrainExaggeration) != null ? _b : this.terrainExaggeration), this.once("load", () => {
  ...
  setHaloFromStyle({ style: t }) {
    ...
    if (JSON.stringify((i = this.halo) == null ? void 0 : i.getConfig()) === JSON.stringify(n == null ? void 0 : n.halo)) {
      if (this.halo && !this.getLayer(this.halo.id)) {
        const l = this.getLayersOrder().indexOf((_a2 = (s = this.space) == null ? void 0 : s.id) != null ? _a2 : "") + 1, u = this.getLayersOrder()[l];
    ...
    (() => {
      ...
      if (this.halo) {
        if (!this.getLayer(this.halo.id)) {
          const c = this.getLayersOrder().indexOf((_a3 = (l = this.space) == null ? void 0 : l.id) != null ? _a3 : "") + 1, p = this.getLayersOrder()[c];
          this.addLayer(this.halo, p);
        }
        const u = (_b = n == null ? void 0 : n.halo) != null ? _b : this.options.halo;
  ...
  setHalo(t) {
    if (this.isGlobeProjection()) {
      ...
      this.halo = new Rr(t), this.once("load", () => {
        var _a2;
        var s;
        const n = this.getLayersOrder(), a = n[0], o = n.indexOf((_a2 = (s = this.space) == null ? void 0 : s.id) != null ? _a2 : "") + 2, i = n[o];
  ...
  recreate() {
    ...
    this.remove(), Object.assign(this, new Co(__spreadValues({}, this.options))), this.once("load", () => {
      this.jumpTo(t);
    });
  }
  /**
  ...
  setStyle(t, n) {
    ...
    try {
      super.setStyle(a.style, n), this.styleInProcess = true;
    } catch (m) {
    ...
    const s = () => {
      ...
      var _a2;
      var g, x, E, C;
      const y = (_a2 = m == null ? void 0 : m.target.getStyle()) != null ? _a2 : a.style, w = this.getLayersOrder()[0];
    ...
    if (this.styleInProcess && !this.spaceboxLoadingState.styleLoadCallbackSet)
      return this.once("style.load", l), this.once("styledata", l), this.spaceboxLoadingState.styleLoadCallbackSet = true, this;
  ...
  setPrimaryLanguage(t) {
    ...
    if (!(a.flag === z.STYLE.flag && n && (n.flag === z.AUTO.flag || n.flag === z.VISITOR.flag)) && (a.flag !== z.STYLE.flag && (this.languageAlwaysBeenStyle = false), this.languageAlwaysBeenStyle || this.primaryLanguage === a && !this.forceLanguageUpdate))
      return;
...
`, ["get", z.LOCAL.flag], { "font-scale": 1.1 }]
  ...
  enableTerrain(t = this.terrainExaggeration) {
    ...
    const n = (o) => {
      ...
      this.isTerrainEnabled = true, this.terrainExaggeration = t, this.on("data", n), this.addSource(X.terrainSourceId, {
        type: "raster-dem",
  ...
  disableTerrain() {
    ...
    const t = performance.now(), n = this.terrain.exaggeration, a = () => {
      ...
      if (this._elevationFreeze = false, o < 0.99) {
        ...
        this.terrain.exaggeration = 0, this.terrainGrowing = false, this.terrainFlattening = false, this.setTerrain(), this.getSource(X.terrainSourceId) && this.removeSource(X.terrainSourceId), this.fire("terrainAnimationStop", { terrain: null });
      this.triggerRepaint();
    };
  ...
  async centerOnIpPoint(t) {
    ...
    this.jumpTo({
      center: [(_a2 = n.longitude) != null ? _a2 : 0, (_b = n.latitude) != null ? _b : 0],
      zoom: t || 11
    });
  }
  getCameraHash() {
...
class ae {
  constructor(e, t, n, a = {}) {
    ...
    this.type = e, this.target = t, this.originalEvent = n != null ? n : null, Object.assign(this, a);
  }
}
const Eo = [
  ...
  Vu.forEach((n) => {
    try {
      r.on(n, (a) => {
        const o = n;
        if (Mo.includes(o)) {
          const f = a, h = f.lngLat && t(f.lngLat), m = __spreadValues({
            imageX: h[0],
            imageY: h[1]
...
function Qu(r) {
  r.transform.getConstrained = function(e, t) {
    ...
    if (w !== void 0 || g !== void 0) {
      const H = new Ko(w != null ? w : m, g != null ? g : y);
...
class Jc extends tc {
  ...
  constructor(t) {
    ...
    v(this, "shouldFitImageToViewport", true);
    if (!t.imageUUID)
    ...
    this.options = __spreadValues(__spreadValues({}, nc), t);
    const n = __spreadValues(__spreadValues({}, this.options), rc);
    delete n.center, this.sdk = new Lo(n), this.sdk.telemetry.registerViewerType("ImageViewer");
    const { imageUUID: a, debug: o } = t;
    this.imageUUID = a, this.debug = o != null ? o : false, this.debug && (this.sdk.showTileBoundaries = this.debug, this.sdk.showPadding = this.debug, this.sdk.showCollisionBoxes = this.debug, this.sdk.repaint = this.debug), this.init();
  }
  /**
  ...
  async init() {
    ...
    try {
      ...
      const { center: o, zoom: i, bearing: s } = this.options, l = o != null ? o : [((_a2 = (t = this.imageMetadata) == null ? void 0 : t.width) != null ? _a2 : 0) / 2, ((_b = (n = this.imageMetadata) == null ? void 0 : n.height) != null ? _b : 0) / 2];
      this.setCenter(l), this.setBearing(s != null ? s : 0), this.options.zoom ? this.setZoom((_c = i != null ? i : (a = this.imageMetadata) == null ? void 0 : a.maxzoom) != null ? _c : 5) : this.fitImageToViewport(), this.sdk.on("wheel", () => {
        ...
        var _a3, _b2;
        var d, f;
        const u = this.getCenter(), c = (_a3 = (d = this.imageMetadata) == null ? void 0 : d.width) != null ? _a3 : 0, p = (_b2 = (f = this.imageMetadata) == null ? void 0 : f.height) != null ? _b2 : 0;
  ...
  fitImageToViewport({ ease: t = false } = {}) {
    ...
    const n = this.pxToLngLat([0, 0]), a = this.pxToLngLat([(_a2 = this.imageMetadata.width) != null ? _a2 : 0, (_b = this.imageMetadata.height) != null ? _b : 0]), o = this.sdk.cameraForBounds([n, a], { padding: 50 });
    o && (t ? this.sdk.easeTo(__spreadProps(__spreadValues({}, o), { pitch: 0 }), null) : this.sdk.jumpTo(__spreadProps(__spreadValues({}, o), { pitch: 0 }), null)), this.shouldFitImageToViewport = true;
  }
  ...
  addImageSource() {
    ...
    this.sdk.addSource("image", __spreadProps(__spreadValues({}, this.imageMetadata), {
      type: "raster",
      bounds: i,
      tiles: [t]
    })), this.sdk.addLayer({
  ...
  flyTo(t, n) {
    ...
    return this.sdk.flyTo(__spreadProps(__spreadValues({}, t), { pitch: 0, center: a }), n);
  }
  //#region jumpTo
  /**
  ...
  jumpTo(t, n) {
    const a = this.pxToLngLat(t.center);
    return this.sdk.jumpTo(__spreadProps(__spreadValues({}, t), { pitch: 0, center: a }), n);
  }
  //#region setZoom
  /**
   * Set the zoom level.
   ...
   */
  panBy(t, n, a) {
    this.sdk.panBy(t, __spreadProps(__spreadValues({}, n), { pitch: 0 }), a);
  }
  //#region panTo
  /**
   ...
   */
  panTo(t, n, a) {
    this.sdk.panTo(this.pxToLngLat(t), __spreadProps(__spreadValues({}, n), { pitch: 0 }), a);
  }
}
function ac(r) {
...
function No(r, e) {
  ...
  for (const c of Array.from(u)) {
    ...
    for (const f of Array.from(p))
      d[(_a2 = O(_(f, "key"))) != null ? _a2 : ""] = O(_(f, "styleUrl"));
    i[`#${Ze(c, "id")}`] = d;
  }
...
function Ca(r) {
  ...
  let e = "", t = 1, n = r;
  return n.startsWith("#") && (n = n.substring(1)), (n.length === 6 || n.length === 3) && (e = n), n.length === 8 && (t = Number.parseInt(n.substring(0, 2), 16) / 255, e = `#${n.substring(6, 8)}${n.substring(4, 6)}${n.substring(2, 4)}`), [e != null ? e : "#000000", t != null ? t : 1];
}
function ic(r) {
  return Do(r.split(" "));
}
    ...
    if (n = G(r, e[a]), n) {
      for (o = 0; o < n.length; o++)
        if (t = n[o], e[a] === "Point")
          s.push({
            type: "Point",
            coordinates: Bo((_a2 = O(_(t, "coordinates"))) != null ? _a2 : "")
          });
        else if (e[a] === "LineString")
          s.push({
            type: "LineString",
            coordinates: Ta((_b = O(_(t, "coordinates"))) != null ? _b : "")
          });
        else if (e[a] === "Polygon") {
          const u = G(t, "LinearRing"), c = [];
          for (i = 0; i < u.length; i++)
            c.push(Ta((_c = O(_(u[i], "coordinates"))) != null ? _c : ""));
          s.push({
            type: "Polygon",
            coordinates: c
          });
...
function lc(r, e, t, n) {
  ...
  if (i && (o.name = i), s && (o.address = s), h) {
    h.startsWith("#") || (h = `#${h}`), o.styleUrl = h, e[h] && (o.styleHash = e[h]), n[h] && (o.styleMapHash = n[h], o.styleHash = e[(_a2 = n[h].normal) != null ? _a2 : ""]);
    const g = t[(_b = o.styleHash) != null ? _b : ""];
    if (g) {
  ...
  if (c !== null && (o.timestamp = (_c = O(_(c, "when"))) != null ? _c : (/* @__PURE__ */ new Date()).toISOString()), m !== null) {
    const g = Ca(O(_(m, "color"))), x = g[0], E = g[1], C = Number.parseFloat((_d = O(_(m, "width"))) != null ? _d : "");
  ...
  if (p) {
    ...
    for (f = 0; f < g.length; f++)
      o[(_e2 = g[f].getAttribute("name")) != null ? _e2 : ""] = (_f = O(_(g[f], "value"))) != null ? _f : "";
    for (f = 0; f < x.length; f++)
      o[(_g = x[f].getAttribute("name")) != null ? _g : ""] = (_h = O(x[f])) != null ? _h : "";
  }
  d !== null && (o.visibility = (_i2 = O(d)) != null ? _i2 : ""), a.coordTimes.length !== 0 && (o.coordTimes = a.coordTimes.length === 1 ? a.coordTimes[0] : a.coordTimes);
  const w = {
    type: "Feature",
  ...
  return Ze(r, "id") && (w.id = (_j = Ze(r, "id")) != null ? _j : void 0), [w];
}
function jo(r, e) {
  const t = G(r, e), n = [], a = [];
  let o = [];
...
function uc(r) {
  ...
  const i = __spreadValues(__spreadValues({}, En(r)), Uo(_(r, "extensions")));
...
function cc(r) {
  ...
  return e === void 0 ? void 0 : {
    type: "Feature",
    properties: __spreadValues(__spreadValues({}, En(r)), Uo(_(r, "extensions"))),
    geometry: {
      type: "LineString",
      coordinates: e.line
    }
...
function pc(r) {
  return {
    type: "Feature",
    properties: __spreadValues(__spreadValues({}, En(r)), Xr(r, ["sym"])),
    geometry: {
      type: "Point",
...
function Uo(r) {
  ...
  if (r) {
    const t = _(r, "line");
    if (t) {
      const n = O(_(t, "color")), a = Number.parseFloat((_a2 = O(_(t, "opacity"))) != null ? _a2 : "0"), o = Number.parseFloat((_b = O(_(t, "width"))) != null ? _b : "0");
...
function Aa(r, e) {
  var _a2;
  return Number.parseFloat((_a2 = Ze(r, e)) != null ? _a2 : "0");
}
function _(r, e) {
  const t = G(r, e);
...
function Xr(r, e) {
  ...
  let n, a;
  for (a = 0; a < e.length; a++)
    n = _(r, e[a]), n && (t[e[a]] = (_a2 = O(n)) != null ? _a2 : "");
  return t;
}
function Bo(r) {
...
function qo(r) {
  ...
  let o;
  return t && (o = Number.parseFloat((_a2 = O(t)) != null ? _a2 : "0"), Number.isNaN(o) || e.push(o)), {
    coordinates: e,
    time: a ? O(a) : null,
    heartRate: n !== null ? Number.parseFloat((_b = O(n)) != null ? _b : "0") : null
  };
}
function dc(r) {
  let e = r;
...
async function hc(r, e = {}) {
  var _a2, _b;
  const t = (_a2 = e.download) != null ? _a2 : false, n = await mc(r);
  if (t) {
    const a = (_b = e.filename) != null ? _b : "maptiler_screenshot.png", o = document.createElement("a");
...
async function gc(r, e, t = {}) {
  ...
  if (typeof n == "string") {
    if (Yt(n))
      ...
      const i = (_a2 = xi(n)) != null ? _a2 : dc(n);
      i && (n = i);
    }
    if (!n)
      throw new Error("Polyline data was provided as string but is incompatible with valid formats.");
  }
  return vc(r, __spreadProps(__spreadValues({}, e), {
    data: n
  }));
}
function vc(r, e) {
  var _a2, _b, _c, _d, _e2, _f, _g, _h, _i2, _j, _k, _l2, _m, _n, _o2, _p2, _q, _r2, _s2, _t2;
  if (e.layerId && r.getLayer(e.layerId))
    throw new Error(`A layer already exists with the layer id: ${e.layerId}`);
  const t = (_a2 = e.sourceId) != null ? _a2 : It(), n = (_b = e.layerId) != null ? _b : Mt(), a = {
    polylineLayerId: n,
  ...
  const o = (_c = e.lineWidth) != null ? _c : 3, i = (_d = e.lineColor) != null ? _d : dr(), s = (_e2 = e.lineOpacity) != null ? _e2 : 1, l = (_f = e.lineBlur) != null ? _f : 0, u = (_g = e.lineGapWidth) != null ? _g : 0;
  let c = (_h = e.lineDashArray) != null ? _h : null;
  const p = (_i2 = e.outlineWidth) != null ? _i2 : 1, d = (_j = e.outlineColor) != null ? _j : "#FFFFFF", f = (_k = e.outlineOpacity) != null ? _k : 1, h = (_l2 = e.outlineBlur) != null ? _l2 : 0;
  if (typeof c == "string" && (c = An(c)), e.outline === true) {
    const m = `${n}_outline`;
    a.polylineOutlineLayerId = m, r.addLayer(
      {
        ...
        source: t,
        layout: {
          "line-join": (_m = e.lineJoin) != null ? _m : "round",
          "line-cap": (_n = e.lineCap) != null ? _n : "round"
        },
        minzoom: (_o2 = e.minzoom) != null ? _o2 : 0,
        maxzoom: (_p2 = e.maxzoom) != null ? _p2 : 23,
        paint: {
  ...
  return r.addLayer(
    {
      ...
      source: t,
      layout: {
        "line-join": (_q = e.lineJoin) != null ? _q : "round",
        "line-cap": (_r2 = e.lineCap) != null ? _r2 : "round"
      },
      minzoom: (_s2 = e.minzoom) != null ? _s2 : 0,
      maxzoom: (_t2 = e.maxzoom) != null ? _t2 : 23,
      paint: __spreadValues({
...
function bc(r, e) {
  ...
  let o = (_c = e.outlineDashArray) != null ? _c : null;
  const i = (_d = e.outlineWidth) != null ? _d : 1, s = (_e2 = e.outlineColor) != null ? _e2 : "#FFFFFF", l = (_f = e.outlineOpacity) != null ? _f : 1, u = (_g = e.outlineBlur) != null ? _g : 0, c = (_h = e.fillColor) != null ? _h : dr(), p = (_i2 = e.fillOpacity) != null ? _i2 : 1, d = (_j = e.outlinePosition) != null ? _j : "center", f = (_k = e.pattern) != null ? _k : null;
    ...
    if (r.addLayer(
      {
        ...
        type: "fill",
        source: t,
        minzoom: (_a3 = e.minzoom) != null ? _a3 : 0,
        maxzoom: (_b2 = e.maxzoom) != null ? _b2 : 23,
        paint: __spreadValues({
      ...
      d === "inside" ? typeof i == "number" ? y = 0.5 * i : y = F(
      ...
      ) : y = 0, r.addLayer(
        {
          ...
          source: t,
          layout: {
            "line-join": (_c2 = e.outlineJoin) != null ? _c2 : "round",
            "line-cap": (_d2 = e.outlineCap) != null ? _d2 : "butt"
          },
          minzoom: (_e3 = e.minzoom) != null ? _e3 : 0,
          maxzoom: (_f2 = e.maxzoom) != null ? _f2 : 23,
          paint: __spreadValues({
...
function wc(r, e) {
  var _a2, _b, _c, _d, _e2, _f, _g, _h, _i2, _j, _k, _l2, _m, _n, _o2, _p2;
  if (e.layerId && r.getLayer(e.layerId))
    throw new Error(`A layer already exists with the layer id: ${e.layerId}`);
  const t = (_a2 = e.minPointRadius) != null ? _a2 : 10, n = (_b = e.maxPointRadius) != null ? _b : 50, a = (_c = e.cluster) != null ? _c : false, o = 20, i = Array.isArray(e.pointColor) ? e.pointColor : Xo.TURBO.scale(10, e.cluster ? 1e4 : 1e3).resample("ease-out-square"), s = i.getBounds(), l = (_d = e.sourceId) != null ? _d : It(), u = (_e2 = e.layerId) != null ? _e2 : Mt(), c = (_f = e.showLabel) != null ? _f : a, p = (_g = e.alignOnViewport) != null ? _g : true, d = (_h = e.outline) != null ? _h : false, f = (_i2 = e.outlineOpacity) != null ? _i2 : 1, h = (_j = e.outlineWidth) != null ? _j : 1, m = (_k = e.outlineColor) != null ? _k : "#FFFFFF";
  let y;
  const w = (_l2 = e.zoomCompensation) != null ? _l2 : true, g = (_m = e.minzoom) != null ? _m : 0, x = (_n = e.maxzoom) != null ? _n : 23;
    ...
    r.addLayer(
      {
        ...
        paint: __spreadValues({
          ...
          "circle-radius": typeof e.pointRadius == "number" ? e.pointRadius : Array.isArray(e.pointRadius) ? F(e.pointRadius) : Jr(C, "point_count", false),
  ...
  if (c !== false && (e.cluster || e.property)) {
    ...
    const C = (_o2 = e.labelColor) != null ? _o2 : "#fff", T = (_p2 = e.labelSize) != null ? _p2 : 12;
    r.addLayer(
      {
        id: E.labelLayerId,
        type: "symbol",
...
function Sc(r, e) {
  ...
  if (e.layerId && r.getLayer(e.layerId))
    throw new Error(`A layer already exists with the layer id: ${e.layerId}`);
  const t = (_a2 = e.sourceId) != null ? _a2 : It(), n = (_b = e.layerId) != null ? _b : Mt(), a = (_c = e.minzoom) != null ? _c : 0, o = (_d = e.maxzoom) != null ? _d : 23, i = (_e2 = e.zoomCompensation) != null ? _e2 : true, s = (_f = e.opacity) != null ? _f : [
    { zoom: a, value: 0 },
    { zoom: a + 0.25, value: 1 },
    { zoom: o - 0.25, value: 1 },
    { zoom: o, value: 0 }
  ...
  const c = (_g = e.intensity) != null ? _g : [
    { zoom: 0, value: 0.01 },
    { zoom: 4, value: 0.2 },
    { zoom: 16, value: 1 }
  ], p = (_h = e.property) != null ? _h : null, d = (_i2 = e.weight) != null ? _i2 : 1;
  let f = 1;
...
const maptilersdk = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AJAXError: Pp,
  AttributionControl: Bc,
  AttributionControlMLGL: dp,
  BoxZoomHandler: Vc,
  BoxZoomHandlerMLGL: vp,
  CanvasSource: Fc,
  CanvasSourceMLGL: ap,
  ColorRamp: A,
  ColorRampCollection: Xo,
  CooperativeGesturesHandler: Hc,
  CooperativeGesturesHandlerMLGL: wp,
  CubemapFaceNames: Ue,
  CubemapImagesPresets: _u,
  CubemapLayer: Pr,
  DOMcreate: Le,
  DOMremove: kt,
  DoubleClickZoomHandler: Up,
  ...
  EdgeInsets: $p,
  Evented: Mp,
  FullscreenControl: Fi,
  FullscreenControlMLGL: yp,
  GeoJSONSource: $c,
  GeoJSONSourceMLGL: op,
  GeolocateControl: Pi,
  GeolocateControlMLGL: fp,
  GeolocationType: qu,
  Hash: Fp,
  ImageSource: Oc,
  ImageSourceMLGL: ip,
  ...
  MapMLGL: ep,
  MapMouseEvent: Wc,
  MapMouseEventMLGL: Cp,
  MapStyle,
  MapStyleVariant,
  MapTouchEvent: Yc,
  MapTouchEventMLGL: Lp,
  MapWheelEvent: Kc,
  MapWheelEventMLGL: kp,
  MaptilerCustomControl: tu,
  MaptilerExternalControl: Gr,
  MaptilerGeolocateControl: eu,
  MaptilerLogoControl: Nn,
  MaptilerNavigationControl: Jl,
  MaptilerProjectionControl: ru,
  MaptilerTerrainControl: Wl,
  Marker: Mc,
  MarkerMLGL: tp,
  MercatorCoordinate: en,
  NavigationControMLGL: pp,
  NavigationControl: Ma,
  Point: Ko,
  Popup: Rc,
  PopupMLGL: rp,
  RadialGradientLayer: Rr,
  RasterDEMTileSource: jc,
  RasterDEMTileSourceMLGL: lp,
  RasterTileSource: Nc,
  RasterTileSourceMLGL: sp,
  ReferenceMapStyle,
  ScaleControl: zi,
  ScaleControlMLGL: mp,
  ScrollZoomHandler: Gc,
  ScrollZoomHandlerMLGL: bp,
  SdkConfig: di,
  ServiceError,
  Style: zc,
  StyleMLGL: np,
  TerrainControMLGL: gp,
  TerrainControl: qc,
  TwoFingersTouchPitchHandler: Xc,
  TwoFingersTouchPitchHandlerMLGL: xp,
  TwoFingersTouchRotateHandler: Bp,
  TwoFingersTouchZoomHandler: Dp,
  TwoFingersTouchZoomRotateHandler: jp,
  VectorTileSource: Uc,
  VectorTileSourceMLGL: up,
  VideoSource: Dc,
  VideoSourceMLGL: cp,
  addProtocol: Wp,
  addSourceType: Kp,
  ...
  cubemapPresets: He,
  data,
  displayWebGLContextLostWarning: Ic,
  elevation,
  expandMapStyle,
  geocoding,
  geolocation,
  getAutoLanguage,
  getBrowserLanguage: Pn,
  getBufferToPixelDataParser,
  getLanguageInfoFromCode,
  getLanguageInfoFromFlag,
  getLanguageInfoFromKey,
  getMapLibreVersion: Ap,
  getMaxParallelImageRequests: Gp,
  getRTLTextPluginStatus: _p,
  getTileCache,
  getVersion: xc,
  getWebGLSupportError: ki,
  getWorkerCount: qp,
  getWorkerUrl: Zp,
  gpx: Oo,
  gpxOrKml: dc,
  hasChildNodeWithName: $o,
  helpers: Qc,
  importScriptInWorkers: Yp,
  isLanguageInfo,
  kml: No,
