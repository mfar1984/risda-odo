{{-- Approve Tuntutan Modal (Centralized Component) --}}

<div id="approvalModal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-[1100]">
    {{-- Backdrop --}}
    <div class="fixed inset-0" onclick="closeApprovalModal()"></div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-green-100" style="font-family: Poppins, sans-serif !important; font-size: 10px !important;">
                            Pengesahan kelulusan tuntutan
                        </p>
                    </div>
                </div>
                <button onclick="closeApprovalModal()" class="text-white hover:text-gray-200">
            ...
            <form id="approvalForm" method="POST" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-green-50 border-2 border-green-300 rounded-sm p-4 text-center">
                        ...
                        <div id="generatedApprovalCode" class="text-[28px] font-bold text-green-700 tracking-[0.3em] font-mono select-all">
                            ------
                        </div>
                ...
                {{-- Confirmation Input --}}
                <div class="mb-6">
                    <label for="approvalCodeConfirm" class="text-[11px] font-medium text-gray-700 mb-2 block" style="font-family: Poppins, sans-serif !important;">
                        Taip Semula Kod untuk Pengesahan <span class="text-red-600">*</span>
                    </label>
                    <input type="text" 
                           id="approvalCodeConfirm" 
                           name="approval_code" 
                           required 
                           minlength="6" 
                           maxlength="6"
                           ...
                           oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, ''); validateApprovalCode()" />
                    <input type="hidden" id="generatedApprovalCodeHidden" name="generated_code" />
                    <p id="approvalCodeMatchMsg" class="mt-2 text-[10px] hidden" style="font-family: Poppins, sans-serif !important;"></p>
                </div>
