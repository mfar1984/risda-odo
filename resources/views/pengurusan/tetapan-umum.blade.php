<x-dashboard-layout title="Tetapan Umum">
    <x-slot name="breadcrumbs">
        ...
        <span class="breadcrumb-separator">></span>
        <span class="breadcrumb-current">Tetapan Umum</span>
    </x-slot>

    <!-- Tetapan Umum Container -->
    <x-ui.page-header 
        title="Tetapan Umum" 
    ...
    >
        <div class="dashboard-maintenance-content">
            ...
            <div class="maintenance-text">
                ...
                <p class="maintenance-subtitle">Tetapan umum sedang dalam proses pembangunan</p>
            </div>
        </div>
    </x-ui.page-header>
</x-dashboard-layout>
