...
<x-dashboard-layout
    ...
    description="Daftarkan rekod penyelenggaraan kenderaan"
    >
        <x-ui.container class="w-full">
            <section>
                <header>
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Penyelenggaraan Kenderaan') }}
                    </h2>

                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Daftarkan rekod penyelenggaraan kenderaan dalam sistem') }}
                    </p>
                </header>

                <form method="POST" action="{{ route('pengurusan.store-selenggara') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                    @csrf
                        ...
                        <div style="display: flex; gap: 20px; align-items: flex-start;">
                            <div style="flex: 1;">
                                ...
                                <select
                                    ...
                                    required
                                    {{ isset($kenderaan) ? 'disabled' : '' }}
                                >
                                    <option value="">Pilih Kenderaan</option>
                                    @if(isset($kenderaan))
                                        <option value="{{ $kenderaan->id }}" selected>{{ $kenderaan->no_plat }} - {{ $kenderaan->nama_penuh }}</option>
                                    @else
                                        @php
                                        ...
                                        @foreach($kenderaanList as $k)
                                            <option value="{{ $k->id }}" {{ old('kenderaan_id') == $k->id ? 'selected' : '' }}>
                                ...
                                @if(isset($kenderaan))
                                    <input type="hidden" name="kenderaan_id" value="{{ $kenderaan->id }}">
                                @endif
                        ...
                        <div style="display: flex; gap: 20px;">
                            ...
                            <div style="flex: 1;">
                                ...
                                >
                                    ...
                                    <option value="dijadualkan" {{ old('status') == 'dijadualkan' ? 'selected' : '' }}>Dijadualkan</option>
                                </select>
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-200">
                        ...
                        <div id="jangka_hayat_section" class="{{ old('tukar_minyak') ? '' : 'hidden' }}">
                            ...
                            <x-forms.text-input
                                ...
                                class="mt-1 block w-full"
                                style="font-family: Poppins, sans-serif !important; font-size: 12px !important;"
                                value="{{ old('jangka_hayat_km', 5000) }}"
