<x-dashboard-layout title="Senarai Pengguna">
    <x-slot name="breadcrumbs">
        ...
        <span class="breadcrumb-separator">></span>
        <span class="breadcrumb-current">Senarai Pengguna</span>
    </x-slot>

    <!-- Senarai Pengguna Container -->
    <x-ui.page-header 
    ...
    >
        <div class="dashboard-maintenance-content">
            ...
            <div class="maintenance-text">
                ...
                <p class="maintenance-subtitle">Senarai pengguna sedang dalam proses pembangunan</p>
            </div>
        </div>
    </x-ui.page-header>
</x-dashboard-layout>
