<x-dashboard-layout title="Laporan Kenderaan">
    <x-slot name="breadcrumbs">
        ...
        <span class="breadcrumb-separator">></span>
        <span class="breadcrumb-current">Laporan Kenderaan</span>
    </x-slot>

    <!-- Laporan Kenderaan Container -->
    <x-ui.page-header 
        title="Laporan Kenderaan" 
        description="Laporan komprehensif mengenai kenderaan dalam sistem"
    >
        <div class="dashboard-maintenance-content">
            ...
            <div class="maintenance-text">
                ...
                <p class="maintenance-subtitle">Laporan kenderaan sedang dalam proses pembangunan</p>
            </div>
        </div>
    </x-ui.page-header>
</x-dashboard-layout>
