<x-dashboard-layout title="Laporan Pemandu">
    <x-slot name="breadcrumbs">
        ...
        <span class="breadcrumb-separator">></span>
        <span class="breadcrumb-current">Laporan Pemandu</span>
    </x-slot>

    <!-- Laporan Pemandu Container -->
    <x-ui.page-header 
        title="Laporan Pemandu" 
        description="Laporan prestasi dan aktiviti pemandu kenderaan"
    >
        <div class="dashboard-maintenance-content">
            ...
            <div class="maintenance-text">
                ...
                <p class="maintenance-subtitle">Laporan pemandu sedang dalam proses pembangunan</p>
            </div>
        </div>
    </x-ui.page-header>
</x-dashboard-layout>
