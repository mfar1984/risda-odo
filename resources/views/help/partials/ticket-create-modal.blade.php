            ...
            <form class="p-6 overflow-y-auto flex-1" style="max-height: calc(85vh - 180px);">
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        value="Perlukan akses ke sistem billing"
                    />
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select class="w-full h-8 px-3 text-[11px] rounded-sm border border-gray-200 focus:ring-0 focus:border-blue-500 bg-white" style="font-family: Poppins, sans-serif !important; font-size: 11px !important; line-height: 32px !important; padding-top: 0 !important; padding-bottom: 0 !important;">
                            ...
                            <option value="akaun">Akaun & Akses</option>
...
Saya memerlukan akses kepada sistem billing untuk proses pengurusan kewangan di bahagian saya. Bolehkah pihak admin membantu untuk memberikan akses tersebut?
...
Terima kasih.</textarea>
                ...
                <div class="mb-4 bg-gray-50 border border-gray-200 rounded-sm p-4">
                    ...
                    <div class="grid grid-cols-2 gap-3 text-[10px]" style="font-family: Poppins, sans-serif !important;">
                        <div>
                            ...
                            <span class="text-gray-900 font-medium ml-2">Faizan Abdullah</span>
                        </div>
                        <div>
                            <span class="text-gray-500">Email:</span>
                            <span class="text-gray-900 font-medium ml-2">faizan@jara.my</span>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span class="text-gray-900 font-medium ml-2">Stesen A</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <button type="button" class="h-8 px-4 text-[11px] rounded-sm border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors inline-flex items-center gap-1.5">
                        <span class="material-symbols-outlined text-[16px]">save</span>
                        Simpan Draft
                    </button>
                    <button type="submit" class="h-8 px-4 text-[11px] font-medium rounded-sm bg-green-600 text-white hover:bg-green-700 transition-colors inline-flex items-center gap-1.5">
