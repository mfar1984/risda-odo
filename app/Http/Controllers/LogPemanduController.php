    ...
    public function update(Request $request, LogPemandu $logPemandu)
    {
        ...
        activity('log_pemandu')
            ...
            ->withProperties([
                ...
                // masa_keluar/masa_masuk are stored as TIME strings; avoid calling format() on strings
                'masa_keluar' => $logPemandu->masa_keluar ?: null,
                'masa_masuk' => $logPemandu->masa_masuk ?: null,
