...
class ProgramController extends Controller
{
    ...
    private function formatProgramData($program)
    {
        return [
            ...
            'tarikh_kelulusan' => $program->tarikh_kelulusan ? $program->tarikh_kelulusan->format('Y-m-d H:i:s') : null,
            'tarikh_mula_aktif' => $program->tarikh_mula_aktif ? $program->tarikh_mula_aktif->format('Y-m-d H:i:s') : null,
            'tarikh_sebenar_selesai' => $program->tarikh_sebenar_selesai ? $program->tarikh_sebenar_selesai->format('Y-m-d H:i:s') : null,
